        ...
        <div className='com_center_wrap'>
          ...
          <div className='container'>
            ...
            <section className='com_pg_tab'>
              <Link to="/front/Mypage/PayInsight" className='tab'>결제 인사이트 목록</Link>
              <Link to="/front/Mypage/PayMentoring" className='tab active'>결제 멘토링 목록</Link>
            </section>
              ...
              <tbody>
                <tr>
                  ...
                  <td className='channel_field'>
                    <Link to="/front/Mypage/Webcam" className='com_btn blue line oval s btn_meeting'><span >화상미팅</span> 3/5</Link>
                    <Link to="/front/Mypage/Chat" className='com_btn blue line s oval'>채팅</Link>
                    <Link to="/front/Mypage/QnaList" className='com_btn blue line s oval btn_qna'>질문과 답변</Link>
                  </td>
